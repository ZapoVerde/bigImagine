...
BigImagine has its own dedicated stack as of 2026-08-04 (`docs/plans/completed/dedicated-infra-plan.md` has the
...
- **`/config/workspace/stacks/bigbrain/`** — bigBrain's own deployed stack. No longer shares
  ...
  owns rows in used to be a real shared-fate risk (`docs/plans/completed/dedicated-infra-plan.md` §1.1 has the

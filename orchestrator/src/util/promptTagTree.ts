 ...
 * This is the "rolls back up to the next level up" contract from docs/prompt-inspector-tag-tree.md
...
/**
 * Loss-tolerant tag-tree parse. See the file preamble and docs/prompt-inspector-tag-tree.md §2

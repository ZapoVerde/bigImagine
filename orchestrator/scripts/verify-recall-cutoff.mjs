...
// BigImagine's single content-vector lane (docs/plans/rag-dynamic-cutoff-plan.md, Stage 1 of the
// CNZ retrieval port). Pure arithmetic: no IO, no settings access. poolSize sizes the SQL LIMIT
// the IO wrapper issues; applyCutoff decides how many of the already-fetched, best-first rows are
// worth injecting. The read-path wiring (settings → pool → slice → telemetry) is proven by
...
import { poolSize, applyCutoff } from '../dist/io/chatMemory/recallCutoff.js';

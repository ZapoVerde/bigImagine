...
-- the vocabulary stays closed to what's actually implemented.
--
-- linked_note_id/linked_chat_id are one-directional, set-once-at-creation, on-delete-set-null
-- pointers — a timer can point at the note/chat it was started from, but that source never needs
-- to know the timer exists.
